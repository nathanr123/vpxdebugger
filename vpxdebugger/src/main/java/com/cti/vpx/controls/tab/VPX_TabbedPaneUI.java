...
public class VPX_TabbedPaneUI extends VPX_BasicTabPaneUI {

	
	public static ComponentUI createUI(JComponent c) {
		return new VPX_TabbedPaneUI();
	}
	...
	protected class ScrollableTabButton extends
			VPX_BasicTabPaneUI.ScrollableTabButton {

		/**
		 * 
		 */
		private static final long serialVersionUID = -8900730218158255678L;
	...
	protected VPX_BasicTabPaneUI.ScrollableTabButton createScrollableTabButton(
			int direction) {
